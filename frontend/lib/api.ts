...
export async function getPatients(): Promise<Patient[]> {
  // In a real app, this would fetch patients from the server
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve([
        { id: "P001", name: "John Smith", dob: "1985-05-15", status: "Up to date" },
        { id: "P002", name: "Sarah Johnson", dob: "1990-10-20", status: "Due soon" },
        { id: "P003", name: "Michael Brown", dob: "1978-03-08", status: "Overdue" },
        { id: "P004", name: "Emily Davis", dob: "2000-12-25", status: "Up to date" },
        { id: "P005", name: "Robert Wilson", dob: "1965-07-30", status: "Overdue" },
      ])
    }, 500)
  })
}
